...
#define EVIOCSREP		_IOW('E', 0x03, uint32_t[2])
#define EVIOCGKEYCODE		_IOR('E', 0x04, uint32_t[2])
#define EVIOCGKEYCODE_V2	_IOR('E', 0x04, input_keymap_entry_t)
#define EVIOCSKEYCODE		_IOW('E', 0x04, uint32_t[2])
#define EVIOCSKEYCODE_V2	_IOW('E', 0x04, input_keymap_entry_t)
...
#define EVIOCGABS(abs)		_IOR('E', 0x40 + (abs), input_absinfo_t)
#define EVIOCSABS(abs)		_IOW('E', 0xc0 + (abs), input_absinfo_t)

#define EVIOCSFF		_IOW('E', 0x80, ff_effect_t)
#define EVIOCRMFF		_IOW('E', 0x81, int32_t)
#define EVIOCGEFFECTS		_IOR('E', 0x84, int32_t)

#define EVIOCGRAB		_IOW('E', 0x90, int32_t)
#define EVIOCREVOKE		_IOW('E', 0x91, int32_t)
