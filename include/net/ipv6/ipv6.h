...
typedef void (*ipv6_error_hook_t)(uint8_t protocol, const ipv6_address_t *source, const ipv6_address_t *destination, const void *transport, size_t transport_length, int error, uint32_t mtu);
