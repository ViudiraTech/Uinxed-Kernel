...
typedef enum { COMPRESSION_NONE, COMPRESSION_GZIP, COMPRESSION_LZMA, COMPRESSION_LZ4, COMPRESSION_ZSTD, COMPRESSION_XZ, COMPRESSION_UNKNOWN } compression_type_t;
