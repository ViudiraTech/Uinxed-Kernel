...
int virtgpu_cmd_create_resource_3d(struct virtio_gpu_device *vgdev, struct virtio_gpu_object *obj,
                                   const struct drm_virtgpu_resource_create *rc);
int virtgpu_cmd_create_blob(struct virtio_gpu_device *vgdev, struct virtio_gpu_object *obj,
...
int virtgpu_cmd_transfer_3d(struct virtio_gpu_device *vgdev, struct virtio_gpu_object *obj,
                            const struct drm_virtgpu_3d_transfer *xf, bool to_host);
int virtgpu_cmd_resource_flush(struct virtio_gpu_device *vgdev, struct virtio_gpu_object *obj,
                               struct virtio_gpu_rect *rect);
...
int virtgpu_cmd_submit_3d(struct virtio_gpu_device *vgdev, uint32_t ctx_id, const void *cmd, uint32_t size,
                          struct virtio_gpu_fence *fence);
int virtgpu_cmd_get_capset_info(struct virtio_gpu_device *vgdev, uint32_t idx, uint32_t *capset_id,
                                uint32_t *max_version, uint32_t *max_size);
int virtgpu_cmd_get_capset(struct virtio_gpu_device *vgdev, uint32_t capset_id, uint32_t version,
...
int  virtgpu_gem_dumb_create(struct drm_file *file_priv, struct drm_device *dev,
                             struct drm_mode_create_dumb *args);
int  virtgpu_gem_dumb_map_offset(struct drm_file *file_priv, struct drm_device *dev,
...
{
    switch (drm_fourcc) {
        case DRM_FORMAT_XRGB8888: return VIRTIO_GPU_FORMAT_B8G8R8X8_UNORM;
        case DRM_FORMAT_ARGB8888: return VIRTIO_GPU_FORMAT_B8G8R8A8_UNORM;
        case DRM_FORMAT_XBGR8888: return VIRTIO_GPU_FORMAT_X8R8G8B8_UNORM;
        case DRM_FORMAT_ABGR8888: return VIRTIO_GPU_FORMAT_A8B8G8R8_UNORM;
        case DRM_FORMAT_RGBX8888: return VIRTIO_GPU_FORMAT_R8G8B8X8_UNORM;
        case DRM_FORMAT_RGBA8888: return VIRTIO_GPU_FORMAT_R8G8B8A8_UNORM;
        case DRM_FORMAT_BGRX8888: return VIRTIO_GPU_FORMAT_X8B8G8R8_UNORM;
        case DRM_FORMAT_BGRA8888: return VIRTIO_GPU_FORMAT_A8B8G8R8_UNORM;
        case DRM_FORMAT_RGB565:   return VIRTIO_GPU_FORMAT_B5G6R5_UNORM;
        case DRM_FORMAT_RGB888:   return VIRTIO_GPU_FORMAT_B8G8R8X8_UNORM;
        default:                  return 0;
    }
}
