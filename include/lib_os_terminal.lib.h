...
extern void terminal_set_auto_flush(bool auto_flush);
extern void terminal_set_bell_handler(void (*handler)(void));
extern void terminal_set_color_scheme(size_t palette_index);
extern void terminal_set_custom_color_scheme(const struct TerminalPalette *palette);
extern const uint8_t *terminal_handle_keyboard(uint8_t scancode);
