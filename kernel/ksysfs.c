...
static ssize_t cmdline_show(struct kobject *kobj, struct attribute *attr,
                            char *buf)
{
    (void)kobj;
    (void)attr;
...
static ssize_t hostname_show(struct kobject *kobj, struct attribute *attr,
                             char *buf)
{
    (void)kobj;
    (void)attr;
...
static ssize_t hostname_store(struct kobject *kobj, struct attribute *attr,
...
static ssize_t ostype_show(struct kobject *kobj, struct attribute *attr,
                           char *buf)
{
    (void)kobj;
    (void)attr;
...
static ssize_t osrelease_show(struct kobject *kobj, struct attribute *attr,
                              char *buf)
{
    (void)kobj;
    (void)attr;
...
static ssize_t uevent_seqnum_show(struct kobject *kobj, struct attribute *attr,
                                  char *buf)
{
    (void)kobj;
    (void)attr;
...
static ssize_t profiling_show(struct kobject *kobj, struct attribute *attr,
                              char *buf)
{
    (void)kobj;
    (void)attr;
...
static ssize_t profiling_store(struct kobject *kobj, struct attribute *attr,
                               const char *buf, size_t count)
{
    (void)kobj;
    (void)attr;
...
static ssize_t uptime_show(struct kobject *kobj, struct attribute *attr,
                           char *buf)
{
    (void)kobj;
    (void)attr;
 ...
 */
static ssize_t kernel_attr_show(struct kobject *kobj, struct attribute *attr,
                                char *buf)
{
...
static ssize_t kernel_attr_store(struct kobject *kobj, struct attribute *attr,
                                 const char *buf, size_t count)
{
...
void ksysfs_init(void)
{
    ...
    if (kernel_ktype.default_attrs) {
        ...
        for (attr = kernel_ktype.default_attrs; *attr; attr++) {
            if ((*attr)->name) {
                sysfs_create_file(kernel_kobj, *attr);
            }
        }
    }
