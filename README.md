...
此项目是一个基于GPL-3.0开源协议的操作系统内核开发项目，名为Uinxed。它由MicroFish和Rainy101112等人于2024年发起并持续开发。Uinxed内核项目遵循开源精神，旨在创建一个自由、透明、任何人都可以使用和修改的操作系统内核。
...
1. Rainy101112（21份源代码）
2. MicroFish（10份源代码）
3. XIAOYI12（3份源代码）
4. copi143（1份）

括弧内仅仅代表初次上传的代码文件数量，不包括修改、整理等。
